...
public class Config {
    ...
    public static final int IMAGEN_SIN_PERSONAJE = android.R.drawable.sym_def_app_icon;
    ...
    public Config(){
        this.nivelTablero=TABLERO_NIVEL_PRINCIPIANTE;
        this.nivel = NIVEL_PRINCIPIANTE;
        this.imagen = IMAGEN1_NORMAL;
    }
